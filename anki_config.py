...
TEMPLATES = [
	{
		...
		'afmt': (
			...
			'.root { margin-top: 15px; font-size: 18px; font-style: italic; color: #8e44ad; }'
			'</style>'
			'<div class="card">'
			'<div class="highlight">{{Meaning}}</div><br>'
